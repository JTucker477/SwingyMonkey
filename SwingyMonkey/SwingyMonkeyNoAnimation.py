...
class SwingyMonkey:
    ...
    def __init__(self, sound=True, text=None, action_callback=None, 
        ...
        self.monkey_left  = self.screen_width/2 - self.monkey_width/2
        self.monkey_right = self.monkey_left + self.monkey_width
        self.monkey_loc   = self.screen_height/2 - self.monkey_height/2
    ...
    def get_state(self):
        ...
        return { 'score': self.score,
                 ...
                 'monkey': { 'vel': self.vel,
                             'top': self.screen_height - self.monkey_loc + self.monkey_height/2,
                             'bot': self.screen_height - self.monkey_loc - self.monkey_height/2},
    ...
    def game_loop(self):
        ...
        if self.next_tree <= 0:
            self.next_tree = self.tree_width * 5 + int(npr.geometric(1.0/self.tree_mean))
